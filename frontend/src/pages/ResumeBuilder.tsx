...
import { 
  ...
  Briefcase, GraduationCap, User, Wrench, FileCheck, UserCheck, LogIn
} from 'lucide-react';
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500 hidden sm:block">
                Crie um currículo aprovado pelas empresas de Natal e baixe em PDF.
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            {isAuthenticated ? (
              <div className="hidden sm:flex items-center gap-1.5 px-3 py-1.5 bg-slate-100 rounded-xl text-xs font-semibold text-slate-700">
                ...
                {effectiveIsPro && (
                  <span className="bg-amber-100 text-amber-800 text-[10px] font-bold px-1.5 py-0.5 rounded-sm">PRO</span>
                )}
              </div>
            ) : (
              <button
            ...
            {!effectiveIsPro && (
              ...
              >
                ...
                <span>Liberar Pacote Pro (R$ 9,90)</span>
              </button>
            )}
            ...
            <div className="bg-white rounded-3xl p-6 border border-slate-200 shadow-xs space-y-4">
              ...
              <div>
                <span className="text-xs font-semibold text-slate-500 block mb-2">
                  Clique para usar um modelo pronto de texto:
                </span>
          ...
          <div className={`lg:col-span-6 sticky top-24 ${mobileTab === 'form' ? 'hidden lg:block' : 'block'}`}>
            <div className="flex items-center justify-between mb-3 px-1">
              <span className="text-xs font-bold text-slate-500 uppercase tracking-wider flex items-center gap-1.5">
                <Eye className="w-4 h-4 text-brand-600" /> Prévia do Documento
              </span>
