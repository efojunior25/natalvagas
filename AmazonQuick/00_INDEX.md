# 📚 AmazonQuick Project Index — Natal Vagas
...
| :--- | :--- | :--- | :--- |
| [gitignore.md](./gitignore.md) | `.gitignore` | 36 | `config` |
...
| [ContractType.java.md](./ContractType.java.md) | `backend/src/main/java/com/natalvagas/domain/ContractType.java` | 9 | `.java` |
| [Job.java.md](./Job.java.md) | `backend/src/main/java/com/natalvagas/domain/Job.java` | 126 | `.java` |
| [JobStatus.java.md](./JobStatus.java.md) | `backend/src/main/java/com/natalvagas/domain/JobStatus.java` | 8 | `.java` |
| [User.java.md](./User.java.md) | `backend/src/main/java/com/natalvagas/domain/User.java` | 42 | `.java` |
| [WorkModel.java.md](./WorkModel.java.md) | `backend/src/main/java/com/natalvagas/domain/WorkModel.java` | 7 | `.java` |
| [CategoryDTO.java.md](./CategoryDTO.java.md) | `backend/src/main/java/com/natalvagas/dto/CategoryDTO.java` | 9 | `.java` |
| [JobCreateDTO.java.md](./JobCreateDTO.java.md) | `backend/src/main/java/com/natalvagas/dto/JobCreateDTO.java` | 55 | `.java` |
| [JobResponseDTO.java.md](./JobResponseDTO.java.md) | `backend/src/main/java/com/natalvagas/dto/JobResponseDTO.java` | 37 | `.java` |
| [CategoryRepository.java.md](./CategoryRepository.java.md) | `backend/src/main/java/com/natalvagas/repository/CategoryRepository.java` | 12 | `.java` |
...
| [webhook.ts.md](./webhook.ts.md) | `frontend/functions/api/payments/pix/webhook.ts` | 109 | `.ts` |
...
| [package.json.md](./package.json.md) | `frontend/package.json` | 31 | `.json` |
...
| [App.tsx.md](./App.tsx.md) | `frontend/src/App.tsx` | 417 | `.tsx` |
...
| [job.ts.md](./job.ts.md) | `frontend/src/types/job.ts` | 54 | `.ts` |
...
| [convert_to_amazon_quick.py.md](./convert_to_amazon_quick.py.md) | `scripts/convert_to_amazon_quick.py` | 110 | `.py` |
...
---
**Total de Arquivos:** 82 arquivos convertidos com sucesso.
